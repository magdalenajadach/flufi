      ...
      <div className="w-[890px] h-[700px] bg-white flex flex-col px-6 pt-6 gap-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          {opportunities.map((opp, index) => (
            <button
              key={index}
              className="flex flex-col gap-3 p-4 border border-neutral-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors text-left"
            >
        ...
        {/* Apply Button */}
        <button className="w-full py-4 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors mt-auto mb-6">
